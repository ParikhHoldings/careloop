    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Start free — no credit card</h1>
          <p className="text-gray-600 mt-2 text-sm">Set up your parent&apos;s profile in 10 minutes.</p>
        </div>
        <SignUp />
      </div>
    </div>
